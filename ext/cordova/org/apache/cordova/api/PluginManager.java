...
public final class PluginManager extends Scriptable {
    ...
    public PluginManager(CordovaExtension ext) {
        this.pluginManagerFunction = new PluginManagerFunction(ext);
    }
     ...
     */
    public void addService(String serviceName, Plugin plugin) {
        pluginManagerFunction.addPlugin(serviceName, plugin);
    }
    ...
    public void setServices(Hashtable services) {
        ...
        while (keys.hasMoreElements()) {
            ...
            pluginManagerFunction.addPlugin(serviceName, (Plugin)services.get(serviceName));
        }
    }
