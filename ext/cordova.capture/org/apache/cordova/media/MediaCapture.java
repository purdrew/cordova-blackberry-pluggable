...
public class MediaCapture extends Plugin {
    ...
    private static String[] jsFiles = { "capture.js", "CaptureAudioOptions.js",
            "CaptureError.js", "CaptureImageOptions.js",
            "CaptureViedoOptions.js", "ConfigurationData.js", "MediaFile.js",
            "MediaFileData.js" };

    public MediaCapture() {
        super("cordova.capture", "Capture", jsFiles);
    }
